...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="footer.css">
   <link rel="stylesheet" type="text/css" href="copyrigt.css">
...
<script async defer crossorigin="anonymous" src="https://connect.facebook.net/en_US/sdk.js#xfbml=1&version=v6.0"></script>
  ...
  <b><nav class = "navbar navbar-expand-lg navbar-light bg-dark navbar-expand-md   fixed-top "></b>
  ...
  <b><a class="navbar-brand active  text-light " href="Homepage.php" > DEVELOPER NEPAL </a></b>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item">
        <a class="nav-link active text-light" href="career..php">Career</a>
      </li>
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          <a class="dropdown-item text-dark" href="web.php">WEBSITES DEVELOPMENT</a>
          <a class="dropdown-item text-dark" href="desktop.php">DESKTOP APP DEVELOPMENT</a>
          <a class="dropdown-item text-dark" href="mobileapp.php">Mobile APP DEVELOPMENT</a>
        </div>
      </li>
      <li class="nav-item">
        <a class="nav-link active text-light " href="form.php">Contact us</a>
      </li>
      <!--<li class="nav-item">
 ...
 <ol class="carousel-indicators container-fluid ">
  ...
  <div class=" carousel-inner"  role="listbox" style=" width:100%; height: 100% !important; ">
    <div class="carousel-item active">
      <img class="d-block w-100  img-fluid" src="Images/wesite.jpg" alt="First slide">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100 img-fluid " src="Images/websit2.jpg" alt="Second slide">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100 img-fluid" src="Images/background.jpg" alt="Third slide">
    </div>
  </div>
...
<div class="container-fluid t ">
  ...
  <div class="card-body">
    ...
    <a href="web.php" class="btn btn-primary">Learn More</a>
  </div>
</div>
       </div>
        <div class="col-lg-4 col-md-4 col-12">
      <div class="card" style="width:400px" >
  <img class="card-img-top  img-fluid" src="Images/webapp.jpg" alt="Card image " style="height: -20px">
  <div class="card-body">
    <h4 class="card-title">Desktop development</h4>
    <p class="card-text">Some example text.</p>
    <a href="desktop.php" class="btn btn-primary">Learn More</a>
  </div>
</div>
       </div>
        <div class="col-lg-4 col-md-4 col-12">
  ...
  <div class="card-body">
    ...
    <p class="card-text">Some example text.</p>
    <a href="mobileapp.php" class="btn btn-primary">Learn More</a>
  </div>
